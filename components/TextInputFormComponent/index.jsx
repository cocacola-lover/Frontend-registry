...
/*
    ...
    optional : 
        placeholder : string
        required : boolean - puts star after label
        vertical : boolean
*/
...
function TextInputField (TextInputProps) {
...
function EmailInputField (EmailInputProps) {
...
function NumberInputField (NumberInputProps) {
...
function AreaInputField (AreaInputProps) {
    ...
    function buildByType (type) {
        switch (type) {
            ...
            case InputFieldType.Text :
                return <TextInputField id={props.id} ratio={1} placeholder={props.placeholder} required={props.required} minLength={props.minLength} maxLength={props.maxLength} name={props.name}/>;

            case InputFieldType.Email :
                return <EmailInputField id={props.id} ratio={1} placeholder={props.placeholder} required={props.required} minLength={props.minLength} maxLength={props.maxLength} name={props.name}/>;

            case InputFieldType.PhoneNumber :
                return <NumberInputField id={props.id} ratio={1} placeholder={props.placeholder} required={props.required} minLength={props.minLength} maxLength={props.maxLength} name={props.name}/>

            case InputFieldType.Area : 
                return <AreaInputField id={props.id} ratio={1} placeholder={props.placeholder} required={props.required} maxLength={props.maxLength} name={props.name} />
        }
    }
